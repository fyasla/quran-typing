    ...
    translation: {
      ...
      settings: {
        ...
        harakat: {
          ...
          importantDesc: 'Voyelles, tanwins, shadda et sukun requis ; les marques mineures (maddah, zéro rond des lettres muettes…) sont automatiques.',
        ...
        smallLetters: {
          ...
          strict: 'Strict',
          strictDesc: 'Alif, waw et ya saghira doivent être tapés avec leurs caractères propres (mapping personnalisé recommandé).',
          flexible: 'Souple',
